...
#         while (not self._isConnected):
        try:
            ...
            print "Could not connect: ", error, "; Shuttting down..."
            self._isConnected = False
    ...
    def start_raw_recording(self, file_name):
        self.raw_file = file(file_name, "at")
        self.raw_start_time = time()
    def start_esense_recording(self, file_name):
        self.esense_file = file(file_name, "at")
...
#                                     print("%.6f,%i\n" %(t, value))
                                ...
                                if a>0:
                                    ...
                                    if v>0:
                                        ...
                                        if self.esense_file:
                                            self.esense_file.write("%.6f,%i," % (time()-self.connection_time, v))
#                                             print("att %.6f,%i\n" % (time()-self.connection_time, v))
                                left-=1
